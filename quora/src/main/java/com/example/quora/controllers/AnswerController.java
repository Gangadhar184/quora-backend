...
public class AnswerController {
    ...
    public List<Answer> getAnswersByQuestionId( @PathVariable Long questionId, @RequestParam int offset, @RequestParam int limit) {
        return answerService.getAnswersByQuestionId(questionId, offset, limit);
    }
